...
# output:
# berhasil membuka file: file_detach.txt
# <_io.BufferedReader name='file_detach.txt'>

# membuka file dengan mode 'w+' untuk membaca dan menulis
fileku = open('file_detach.txt', 'w+')
...
# output:
# hello world
# <_io.BufferedRandom name='file_detach.txt'>
