...
# jika suatu fungsi memiliki argument atau parameter yang jumlahnya sewenang-wenang/bebas
def fungsi(**kwargs):
    print(type(kwargs))
    print(kwargs)
    
fungsi(nama='alice', usia=23)
# <class 'dict'>
# {'nama': 'alice', 'usia': 23}

fungsi(nama='carl', usia=25, alamat='jakarta')
# <class 'dict'>
# {'nama': 'carl', 'usia': 25, 'alamat': 'jakarta'}

fungsi(nama='eliot', usia=21, alamat='bandung', jurusan='teknik komputer')
# <class 'dict'>
# {'nama': 'eliot', 'usia': 21, 'alamat': 'bandung', 'jurusan': 'teknik komputer'}
